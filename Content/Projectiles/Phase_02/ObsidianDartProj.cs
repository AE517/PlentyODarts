...
namespace PlentyODarts.Content.Projectiles.Phase_02
{
    public class ObsidianDartProj : DartProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (_charged || player.HasItem(ItemID.LavaBucket))
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            if (!_charged && !Main.player[Projectile.owner].HasItem(ItemID.LavaBucket)) return;
        ...
        private void Explode(int damage, int width, int height)
        {
            DartUtils.SoundFxVolume(SoundID.Item89, Projectile.position, .7f);
            DartUtils.SoundFxVolume(SoundID.Item14, Projectile.position, 0, .4f);
            ...
            Array.ForEach(
                ...
                npc =>
                {
                    if (!npc.Hitbox.Intersects(rect) || npc.townNPC) return;
